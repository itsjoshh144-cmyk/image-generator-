...
import { PencilIcon, SparklesIcon, WandSparklesIcon } from "lucide-react";
...
interface PromptBoxProps {
  ...
  isEnhancing: boolean;
  sourceImage?: string;
  onSourceImageChange: (dataUrl: string | undefined) => void;
  onSourceImageError: (message: string) => void;
}
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4 shadow-2xl shadow-black/40 backdrop-blur-xl sm:p-6">
      <Textarea
        ...
        placeholder={
          sourceImage
            ? "Describe what to change… add a sunset sky, turn it into a watercolor painting, remove the background…"
            : "Describe anything… a bioluminescent forest at midnight, a vintage sports car on a coastal highway, a portrait of a cyberpunk samurai…"
        }
        rows={4}
